  ...
  return (
    <div className='bg-black/70 w-full sm:w-[450px] m-auto px-6 md:px-16 py-8 md:py-12 mx-4 sm:mx-auto flex items-center rounded-lg'>
      <div className="w-full">
        ...
        <div className="my-2">
          <button onClick={handleSignUp} disabled={loadingBtn ? true : false} className="flex items-center justify-center px-4 py-3 mt-4 bg-blue-500 hover:bg-blue-600 text-white w-full rounded-[4px] disabled:bg-blue-800">
            {
        ...
        <div className="text-md mt-8 flex items-center gap-2">
          ...
          <Link to={PAGE.SIGNIN} className='text-gray-500 text-sm hover:text-white'>Sign In</Link>
        </div>
      </div>
    </div>
  )
