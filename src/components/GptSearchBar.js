  ...
  return (
    <>
      <div className="px-4 md:px-12 py-3 text-white max-w-4xl text-center m-auto mt-12">
        <h1 className="text-3xl md:text-5xl mb-3 font-bold">Your Movie Genie Awaits!</h1>
        <p className="text-gray-400 text-sm md:text-lg">Bring the Family Together with Perfect Picks for Movie Night!</p>
      </div>
      <div className="px-4 md:px-12 py-3 sticky top-[68px] z-[99999]" style={{ background: `rgba(20, 20, 20, ${searchOpacity})` }}>
        <form onSubmit={(e) => e.preventDefault()}>
          <div className="flex gap-1">
            ...
            <button
              className={`py-4 md:py-6 w-24 px-2 md:px-5 flex items-center justify-center bg-red-primary rounded text-white disabled:bg-blue-800`}
          ...
          <p className='text-xs mt-1'>
            ...
            <a href="https://www.linkedin.com/in/divyansh-gabra/" target="_blank" rel="noreferrer" className='ml-2 text-sm text-gray-400 hover:text-gray-200'>Request now</a>
          </p>
        </form>
      </div>
    </>
