  ...
  return (
    <div className='broswe-page'>
      ...
      <div className='moview-by-type px-4 md:px-12 md:mt-[-10%] xl:mt-[-15%] z-50 relative'>
        ...
        {
          movies.topRated ? (
            <MovieSlider type={null} heading="Top Picks For You" data={movies.topRated} />
          ) : (
            <MovieSliderShimmer dimention={'w-28 md:w-36'} />
          )
        }
        ...
        {
          movies.popular ? (
            <MovieSlider type={null} heading="SuperHits" data={movies.popular} />
          ) : (
            <MovieSliderShimmer dimention={'w-28 md:w-36'} />
          )
        }
