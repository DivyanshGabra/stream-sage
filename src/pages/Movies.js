  ...
  return (
    <div className='broswe-page'>
      ...
      <div className='moview-by-type px-4 md:px-12 md:mt-[-10%] xl:mt-[-15%] z-50 relative'>
        {
          movies.bollywood ? (
            <MovieSlider heading="Bollywood Superhits" data={movies.bollywood} />
          ) : (
        ...
        {
          movies.hollywood ? (
            <MovieSlider heading="Hollywood" data={movies.hollywood} />
          ) : (
            <MovieSliderShimmer dimention={'w-28 md:w-36'} />
          )
        }
        ...
        {
          movies.romance ? (
            <MovieSlider heading="Romance" data={movies.romance} />
          ) : (
            <MovieSliderShimmer dimention={'w-28 md:w-36'} />
          )
        }
        ...
        {
          movies.horror ? (
            <MovieSlider heading="Horror" data={movies.horror} />
          ) : (
            <MovieSliderShimmer dimention={'w-28 md:w-36'} />
          )
        }
        ...
        {
          movies.comedy ? (
            <MovieSlider heading="Indian Comedy" data={movies.comedy} />
          ) : (
            <MovieSliderShimmer dimention={'w-28 md:w-36'} />
          )
        }
        ...
        {
          movies.adventure ? (
            <MovieSlider heading="Adventure" data={movies.adventure} />
          ) : (
            <MovieSliderShimmer dimention={'w-28 md:w-36'} />
          )
        }
